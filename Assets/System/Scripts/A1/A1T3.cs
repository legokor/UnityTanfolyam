...
public class A1T3 : Task
{
    ...
    public override void SetupTask()
    {
        ...
        weapon = w.GetComponentInChildren<Fegyver>();
        subTasks.Add(new SubTask("Hozz létre prefabot az asztalon található Lövedék-ből, és add át a FegyverRendszer/Fegyver prefab megfelelő változójának!"));
